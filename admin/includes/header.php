...
$uni_name = get_setting('university_name') ?: 'University';
?>
<header class="admin-header">
    <div class="d-flex align-items-center gap-3">
        ...
        <img src="../<?= htmlspecialchars($uni_logo) ?>" alt="<?= htmlspecialchars($uni_name) ?> Logo" class="brand-logo-img brand-logo-img--header d-none d-lg-block">
        <?php endif; ?>
